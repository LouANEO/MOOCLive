...
do
	...
	ls $1/TxtData/$folder | awk '{gsub(/\.txt/,"");print $1,$5}'>> $1/Extraction/fichiersTemp2.txt
	...
	rm $1/Extraction/fichiersTemp.txt
	rm $1/Extraction/fichiersTemp2.txt
